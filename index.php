<!DOCTYPE html>
	<head>
		<title>Ann Arbor National Day of Civic Hacking - A2 Hack for Change</title>
		<meta name="keywords" content="Ann Arbor National Day of Civic Hacking, Hackathon, Hack, Ann Arbor, A2 Hack for Change">
		<meta name="description" content="Ann Arbor is taking part in the National Day of Civic Hacking June 1-2, 2013. The event will leverage the expertise and entrepreneurial spirit of those outside federal, state and local government to drive meaningful, technology-based solutions for federal, state and local government. It demonstrates what's possible when we all work together to strengthen our society and our lives">
		...
		<script type="text/javascript" src="http://maps.googleapis.com/maps/api/js?sensor=true"></script>
		    ...
		    <script type="text/javascript">
				$(document).ready(function() {
    		        ...
    		        var contentString = '<h2>The Forge</h2><span>1327 Jones Drive, Ann Arbor, MI 48105</span>';
...
<div id="content">
	...
	<center><iframe src="badge.html"></iframe></center> 
	...
	<h1 id="help">Get involved</h1>
		<span class="text">
            ...
            Pre-registrations closed. See you at the event!
	...
	<h1 id="faq">FAQ</h1>
		<span class="text">
			...
			<h2 id="location">Where is the event going to be held?</h2>
				A2 Hack for Change will be hosted at the Forge, at 1327 Jones Dr, Ann Arbor, MI.
		...
		<div class="banner">Local Sponsors</div>
			<span class="text" style="margin-bottom: 55px;">
				<span class="text" id="localsponsorsone" style="margin-bottom: 165px;">
		...
		<div class="banner">National Sponsors</div>
			...
			<span class="text" id="sponsorstwo" style="margin-bottom: 165px;">
